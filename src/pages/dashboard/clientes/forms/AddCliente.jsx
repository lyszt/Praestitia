        ...
        <div>
            ...
            <div className="flex flex-row">
                <button
                    ...
                    className="flex border border-slate-700 flex-row gap-2 mt-5 ml-5 mb-5 transition duration-100 rounded p-3 justify-center items-center bg-gray-800 text-slate-50 hover:bg-slate-700"
                >
